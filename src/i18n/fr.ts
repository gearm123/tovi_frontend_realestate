export const frPatch = {
  ...
  filters: {
    ...
    rooms: 'Pièces',
    roomsBedrooms: 'Pièces / chambres',
    any: 'Tous',
    roomsPlus: '{count}+',
    size: 'Surface',
    anySize: 'Toute surface',
    sizePlus: '{count}+ m²',
  ...
  property: {
    ...
    yes: '✓',
    no: '—',
    highlightsTitle: 'Détails du bien',
    specialInfoTitle: 'Informations particulières',
  ...
  map: {
    ...
    priceMaxValue: 'Max ₪{amount}',
    priceMaxAria: 'Filtrer les biens par prix maximum',
